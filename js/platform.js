    ...
    async function submitLead() {
      ...
      try {
        ...
        const lead = {
          ...
          // Link to the submitting user and target if available
          ...(currentUser?.id ? { user_id: currentUser.id } : {}),
          ...(isVendor && selectedVendorId ? { vendor_id: selectedVendorId } : {}),
          ...(!isVendor && selectedInstallerId ? { installer_id: selectedInstallerId } : {}),
        };
        ...
        if (result.success) {
          ...
          lastSubmittedLeadId = result.id || null;
