    ...
    async function renderJobLeads() {
      ...
      try {
        ...
        if (isClosed) {
          ...
          buttons = `
            <button class="btn btn-success small-btn" onclick="openQuoteBuilderFromLead('${leadEnc}')" style="white-space:nowrap;">📋 Build Quote</button>
            <button class="btn btn-outline small-btn" onclick="contactLeadPhone('${phone}')" style="white-space:nowrap;">📞 Call</button>
            <button class="btn btn-outline small-btn" onclick="contactLeadEmail('${email}')" style="white-space:nowrap;">✉️ Email</button>`;
        }
