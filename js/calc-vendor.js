  ...
  function l4v__calcSPD(pps){
    var stringVoc = pps * l4v_PANEL.voc;
    ...
    return {
      ...
      ac: {uc: l4v_PC.acSpd.uc, p: l4v_PC.acSpd.p}
    };
  }
  ...
  function l4v__buildBOM(s,bi){
    ...
    if(s.earth){
      add('Earthing Rod','3m × 16mm Copper-Bonded Rod',s.earth.rods,l4v_PC.earthRod.p);
      add('Earthing Conductor',s.earth.condS+'mm² Bare Copper ~5m/rod',s.earth.rods*5,l4v_PC.earthCond.p);
      add('Earth Pit Cover','PVC Earth Pit Cover',s.earth.rods,l4v_PC.earthPit.p);
    }
