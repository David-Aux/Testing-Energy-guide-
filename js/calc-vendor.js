  ...
  function l4v__runEngine(apps){
    ...
    if(V===24 && reqKwh>V24_CEILING){
      var inv48=l4v_INVERTER_DB.filter(function(i){return i.v===48;}).find(function(i){return i.kva>=inv.kva;});
      if(!inv48) inv48=l4v_INVERTER_DB.filter(function(i){return i.v===48;})[0];
