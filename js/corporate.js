    ...
    try {
      ...
      if (breakdownEl) {
        ...
        breakdownEl.innerHTML = sorted.length === 0
          ? '<div style="text-align:center;padding:20px 0;"><div style="font-size:28px;opacity:0.3;">🗺</div><div style="font-size:13px;color:#4b5472;margin-top:8px;">No submissions yet. Share the agent link to get started.</div></div>'
        ...
        <div style="background:#141720;border:1px solid #1e2235;border-radius:14px;padding:16px;margin-bottom:10px;">
          <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:10px;">
            <div>
              ...
              <div style="font-family:'DM Mono',monospace;font-size:10px;color:#4b5472;letter-spacing:0.06em;">#${sub.agent_code}</div>
            </div>
