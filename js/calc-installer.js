  ...
  function l4i__renderResults(s){
    ...
    // Deferred scroll - waits for forceResetScroll chain to finish
    setTimeout(function(){
      var r=document.getElementById('l4i-results');
      if(!r)return;
      var rp=document.querySelector('#installer-calculator .right-panel');
      if(rp){rp.scrollTo({top:r.offsetTop-16,behavior:'smooth'});}
