  ...
  function l4u__runEngine(apps){
    ...
    var conflict=false; // voltage never jumps — kept for backward compat with renderResults
    ...
    var selPack=null;
    if(V===12){
      // 12V: find smallest pack where units=1 covers rawAh, else use largest
      ...
      // 24V/48V: find smallest single pack that covers reqKwh; if none, use 2× largest
