  ...
  function l4u__runEngine(apps){
    ...
    // kWh escalation: if required kWh exceeds 24V ceiling (7.68kWh), step to 48V
    // keeping the same kVA — this is the only legitimate voltage escalation
    var DOD=0.8,EFF=0.85;
    var rawAh=dw/(V*DOD*EFF);
    var reqKwh=rawAh*V/1000;
    var V24_CEILING=7.68;
    if(V===24 && reqKwh>V24_CEILING){
      // Energy need genuinely exceeds 24V single-pack ceiling — step to 48V
      // Find 48V inverter at same or nearest kVA
      var inv48=l4u_INVERTER_DB.filter(function(i){return i.v===48;}).find(function(i){return i.kva>=inv.kva;});
      if(!inv48) inv48=l4u_INVERTER_DB.filter(function(i){return i.v===48;})[0];
